...
The keys live in `.claude/settings.json` (project) or `D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/settings.json` (global) — **not** in `.planning/config.json`:
