...
- **Global scope**: `D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/notes/`)
...
2. Glob `D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/notes/*.md` (if directory exists) — global notes
...
Global (D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/notes/` — works in any directory
