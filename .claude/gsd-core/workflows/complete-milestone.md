...
**If doesn't exist:** Create from template at `D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/gsd-core/templates/retrospective.md`.
