...
Key references:
- @D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/gsd-core/references/ui-brand.md (display patterns)
- @D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/gsd-core/USER-PROFILE.md"
...
```bash
cp "D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/gsd-core/USER-PROFILE.md" "D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/gsd-core/references/user-profiling.md`
...
Reference: @D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/CLAUDE.md
```
