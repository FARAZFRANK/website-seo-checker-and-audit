...
<required_reading>
@D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/gsd-core/references/domain-probes.md
@D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/gsd-core/references/gate-prompts.md
@D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/gsd-core/references/universal-anti-patterns.md
</required_reading>
...
if [ -f "D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/gsd-core/USER-PROFILE.md" ]; then
  ADVISOR_MODE=true
else
  ADVISOR_MODE=false
fi
...
Read `@D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/gsd-core/references/scout-codebase.md` — it contains the phase-type→map selection table, single-read rule, no-maps fallback, and `<codebase_context>` output schema. Then execute:
