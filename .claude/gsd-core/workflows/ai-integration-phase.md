...
<required_reading>
@D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/gsd-core/references/ai-frameworks.md
@D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/agents/gsd-eval-planner.md for instructions.
