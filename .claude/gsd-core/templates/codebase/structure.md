...
- Usage: Reference from command with `@D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/wamp64/www/dev/wp-content/plugins/frank-website-seo-checker-and-audit/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
